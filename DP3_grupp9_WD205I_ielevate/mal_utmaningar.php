...
$stmt_comments->bindParam(1, $offset_comments, PDO::PARAM_INT);
$stmt_comments->bindParam(2, $limit, PDO::PARAM_INT);
...
$stmt_goals->bindParam(1, $_SESSION['user_username'], PDO::PARAM_STR);  
$stmt_goals->bindParam(2, $offset_goals, PDO::PARAM_INT);  // Offset för paginering
$stmt_goals->bindParam(3, $limit, PDO::PARAM_INT);  // Limit för paginering
$stmt_goals->execute();
$goals = $stmt_goals->fetchAll();

if (empty($goals)) {
    echo "Inga mål hittades för denna användare.";
}
...
<body class="body">
    <main class="main-container">
        ...
        <div class="community-comments">
            ...
            <form action="includes/save_comment.inc.php" method="post">
